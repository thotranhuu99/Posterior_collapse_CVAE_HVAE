...
def main(args):
    ...
    npy_path = "output/cvae_linear/npy"
...
if __name__ == "__main__":
    ...
    parser.add_argument('--image_folder', type=str, default="output/cvae_linear/image/")
    parser.add_argument('--json_folder', type=str, default="output/cvae_linear/json/")
